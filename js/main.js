...
import { initPreloader } from './modules/preloader.js?v=12';
import { initNav } from './modules/nav.js?v=12';
import { initTicker } from './modules/hero-ticker.js?v=12';
import { initAct } from './modules/act.js?v=12';
import { initServices } from './modules/services.js?v=12';
import { initTestimonials } from './modules/testimonials.js?v=12';
import { initProcess } from './modules/process.js?v=12';
import { initWhatsApp } from './modules/whatsapp.js?v=12';
